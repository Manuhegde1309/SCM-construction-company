...
--
-- Current Database: `dbms_project_testing`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `dbms_project_testing` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `dbms_project_testing`;
...
INSERT INTO `Company_Inventory` VALUES ('c001','BRICKS',493),('c002','CEMENT',1000),('c001','CEMENT',20),('c005','IRON',50),('c001','STEEL',100);
...
INSERT INTO `Construction_Company` VALUES ('420','dert',10000000.00,'421'),('c001','buildcorp',14830096.00,'a001'),('c002','ABC Constructions',10500000.00,'a002'),('c003','XYZ Builders',10000000.00,'a003'),('c004','summit builders',10000000.00,'a004'),('c005','peaky blinders',89985000.00,'a005'),('c006','beta builders',10000000.00,'a006');
...
INSERT INTO `Order_info` VALUES ('OR0754','p008','c001','s004','EMS',100,35000.00,'Accepted'),('OR1c7b','p003','c005','s002','TNT',50,15000.00,'Accepted'),('OR36bc','p001','c001','s001',NULL,6,3006.00,'Pending'),('OR60af','p001','c002','s001','FDX',1000,500000.00,'Accepted'),('OR914b','p006','c004','s003',NULL,1000,400000.00,'Pending'),('ORb6f6','p001','c001','s001',NULL,7,3507.00,'Pending'),('ORbd4c','p001','c001','s001','FDX',20,10000.00,'Accepted'),('ORc062','p004','c002','s002',NULL,10,10000.00,'Rejected'),('ORc35a','p001','c001','s001',NULL,2,1002.00,'Pending'),('ORcd3c','p002','c001','s001','DHL',500,125000.00,'Accepted'),('ORd0d6','p002','c001','s001',NULL,3,750.00,'Pending'),('ORe9ee','p005','c001','s003',NULL,500,50000.00,'Pending'),('ORf79e','p007','c005','s004',NULL,100,15000.00,'Rejected');
...
INSERT INTO `Product_info` VALUES ('p001','CEMENT',501.00,'s001',8980),('p002','BRICKS',250.00,'s001',9500),('p003','IRON',300.00,'s002',9950),('p004','GOLD',1000.00,'s002',10000),('p005','BRONZE',100.00,'s003',10000),('p006','SILVER',400.00,'s003',10000),('p007','COPPER',150.00,'s004',10000),('p008','STEEL',350.00,'s004',9900);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_order_info`(
...
-- Dump completed on 2024-11-20 14:46:02
